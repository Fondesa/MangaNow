...
import com.fondesa.manganow.activity.ActivitiesModule
...
@Module(includes = [RemoteModule::class, DatabaseModule::class, ExecutorModule::class, ActivitiesModule::class])
class AppModule {
