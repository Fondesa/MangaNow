...
object Pragma {
     ...
     */
    fun readLong(name: String) = raw("PRAGMA $name") { it.simpleQueryForLong() }
     ...
     * @return [Statement] with a [PlainExecutor] that will run a query.
     */
    fun readString(name: String) = raw("PRAGMA $name") { it.simpleQueryForString() }
     ...
     */
    fun write(name: String, value: Any) = raw("PRAGMA $name = $value") { it.execute() }
