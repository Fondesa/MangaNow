...
import com.fondesa.data.database.reader.DatabaseReader
 ...
 */
class QueryExecutor<R : DatabaseReader>(private val cursor: Cursor, val reader: (Cursor) -> R) :
    Executor<QueryExecutor.Handler<R>> {

    override fun execute(): Handler<R> = Handler(cursor, reader)
