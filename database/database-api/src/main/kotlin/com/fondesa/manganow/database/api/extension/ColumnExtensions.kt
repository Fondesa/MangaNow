...
package com.fondesa.manganow.database.api.extension

import com.fondesa.manganow.database.api.clause.ColumnExpression
import com.fondesa.manganow.database.api.clause.Expression
...
fun Column<*>.isNotNull() =
    ColumnExpression(this, " IS NOT NULL")
 ...
 * @return instance of [ColumnExpression].
 */
fun <T : Any> Column<T>.equalTo(value: T) =
    ColumnExpression(
        this,
        " = ?",
        wrap(value)
 ...
 * @return instance of [ColumnExpression].
 */
fun <T : Any> Column<T>.equalTo(column: Column<T>) =
 ...
 * @return instance of [ColumnExpression].
 */
fun <T : Any> Column<T>.notEqualTo(value: T) =
    ColumnExpression(
        this,
        " <> ?",
        wrap(value)
 ...
 * @return instance of [ColumnExpression].
 */
fun <T : Any> Column<T>.majorThan(value: T) =
    ColumnExpression(
        this,
        " > ?",
        wrap(value)
 ...
 * @return instance of [ColumnExpression].
 */
fun <T : Any> Column<T>.minorThan(value: T) =
    ColumnExpression(
        this,
        " < " + wrap(value)
    )
 ...
 * @return instance of [ColumnExpression].
 */
fun <T : Any> Column<T>.majorOrEqualThan(value: T) =
    ColumnExpression(
        this,
        " >= ?",
        wrap(value)
 ...
 * @return instance of [ColumnExpression].
 */
fun <T : Any> Column<T>.minorOrEqualThan(value: T) =
    ColumnExpression(
        this,
        " <= ?",
        wrap(value)
 ...
 * @return instance of [ColumnExpression].
 */
fun <T : Any> Column<T>.like(value: T) =
    ColumnExpression(
        this,
        " LIKE ?",
        wrap(value)
 ...
 * @return instance of [ColumnExpression].
 */
fun <T : Any> Column<T>.like(column: Column<T>) =
    ColumnExpression(this, " LIKE " + column.fullName)
...
fun <T : Any> Column<T>.between(first: Column<T>, second: Column<T>) =
    ColumnExpression(
        this,
        " BETWEEN " + first.fullName + " AND " + second.fullName
    )
 ...
 * @return instance of [ColumnExpression].
 */
fun <T : Any> Column<T>.within(vararg values: T) =
    ColumnExpression(
        this,
...
fun <T : Any> Column<T>.within(vararg columns: Column<T>) =
    ColumnExpression(
        this,
        " IN (" + columns.joinToString { it.fullName } + ")")
 ...
 * @return instance of [ColumnExpression].
 */
fun <T : Any> Column<T>.notWithin(vararg values: T) =
    ColumnExpression(
        this,
...
fun <T : Any> Column<T>.notWithin(vararg columns: Column<T>) =
    ColumnExpression(
        this,
        " NOT IN (" + columns.joinToString { it.fullName } + ")")
