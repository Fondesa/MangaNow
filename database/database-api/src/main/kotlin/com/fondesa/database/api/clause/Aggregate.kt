...
class Aggregate private constructor(val fullName: String, val alias: String) {
    ...
    companion object {
         ...
         */
        fun avg(column: Column<*>) =
            aggregateSingleColumn("avg", column)
         ...
         */
        fun max(column: Column<*>) =
            aggregateSingleColumn("max", column)
         ...
         */
        fun min(column: Column<*>) =
            aggregateSingleColumn("min", column)
         ...
         */
        fun sum(column: Column<*>) =
            aggregateSingleColumn("sum", column)
         ...
         */
        fun total(column: Column<*>) =
            aggregateSingleColumn(
                "total",
                column
            )

        private fun aggregateSingleColumn(name: String, column: Column<*>) = Builder(
            name
        )
