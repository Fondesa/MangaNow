...
/**
 * Concatenate [Expression]s with the AND keyword.
 ...
 */
class AndExpression(first: Expression, second: Expression, vararg others: Expression) :
    MergeExpression() {
    ...
    override fun mergeText(): String = "AND"
}