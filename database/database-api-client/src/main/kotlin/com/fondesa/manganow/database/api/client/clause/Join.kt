...
object Join {
     ...
     */
    fun inner(table: String, on: String) = raw(
        Join.Type.INNER,
        table,
        on
    )
     ...
     * @return raw INNER JOIN clause.
     */
    fun inner(table: String, on: Expression) =
        inner(table, on.raw())
     ...
     */
    fun leftOuter(table: String, on: String) =
        raw(
     ...
     * @return raw LEFT OUTER JOIN clause.
     */
    fun leftOuter(table: String, on: Expression) =
        leftOuter(table, on.raw())
