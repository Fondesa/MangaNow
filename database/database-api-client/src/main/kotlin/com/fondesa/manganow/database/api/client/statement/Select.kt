...
import com.fondesa.manganow.database.api.client.clause.*
import com.fondesa.manganow.database.api.client.execution.QueryExecutor
import com.fondesa.manganow.database.api.client.extension.isNullOrEmpty
import com.fondesa.manganow.database.api.client.extension.plusArray
import com.fondesa.manganow.database.api.client.reader.SQLiteColumnReader
import com.fondesa.manganow.database.api.client.reader.SQLiteRawReader
import com.fondesa.manganow.database.api.client.statement.base.SQLiteQueryStatement
...
object Select {
    ...
    fun raw(statement: String, args: Array<out String>) =
        SQLiteQueryStatement.lined(statement, args) {
            QueryExecutor(
                it
            ) { SQLiteRawReader(it) }
        }
    ...
    class Builder internal constructor() {
         ...
         * @see Join.inner
         */
        fun innerJoin(table: String, on: Expression) = apply {
            joins.add(
                Join.inner(table, on)
            )
        }
