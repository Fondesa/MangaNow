...
@Reusable
class SortOrderRemoteStorageMapper @Inject constructor() :
    RemoteStorageMapper<@JvmSuppressWildcards SortOrderList> {

    override fun map(json: JsonElement): SortOrderList = json.asJsonArray.mapJsonObject {
        SortOrder(
            id = it["id"].asLong,
