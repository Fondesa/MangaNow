...
package com.fondesa.remote.impl.client
...
class HttpClient @Inject constructor(
    ...
    override fun load(task: RemoteTask): JsonElement {
        ...
        if (!connectivityManager.isConnected())
            throw com.fondesa.remote.api.exception.ConnectivityException()
        ...
        val response = try {
            ...
            throw com.fondesa.remote.api.exception.TimeoutException()
        }
        ...
        if (!response.isSuccessful) {
            response.close()
            throw com.fondesa.remote.api.exception.ResponseException(
                code,
        ...
        } ?: throw com.fondesa.remote.api.exception.ResponseException(code, "response body is null")
    }
