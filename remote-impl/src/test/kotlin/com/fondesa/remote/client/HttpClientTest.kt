...
class HttpClientTest {
    ...
    private val client = HttpClient(gson, connectivityManager, 500L, TimeUnit.MILLISECONDS)
    ...
    private class ResponseCodeMatcher(private val code: Int) :
        ...
        override fun matchesSafely(item: ResponseException): Boolean = item.code == code
