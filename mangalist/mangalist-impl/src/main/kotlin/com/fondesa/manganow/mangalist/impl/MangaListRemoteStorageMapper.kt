...
class MangaListRemoteStorageMapper @Inject constructor() :
    RemoteStorageMapper<@JvmSuppressWildcards MangaList> {

    override fun map(json: JsonElement): MangaList = json.asJsonArray.mapJsonObject {
        Manga(
            id = it["id"].asLong,
